    ...
    return /* html */ `
      <section class="screen screen--settings">
        <header class="settings-nav">
          <button class="ed-btn ed-btn--ghost" type="button">‹ 책장</button>
        ...
        <div class="ed-page" style="padding: 14px 20px 18px;">
          ...
          <div class="ed-list">
            ...
            <button class="ed-list__item" type="button">초대 링크 다시 만들기<span class="ed-list__chev">›</span></button>
          ...
          <div class="ed-list">
            ...
            <button class="ed-list__item" type="button">1인 모드로 전환<span class="ed-list__chev">›</span></button>
          </div>
