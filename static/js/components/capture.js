/**
 * 04 · 캡처 — 호스트 앱(Safari) 위에 Pairchive 시트가 올라옴
 */
export default {
  id: 'capture',
  label: '캡처',
  ...
  render() {
    return /* html */ `
      <section class="screen screen--capture">
        ...
        <div class="capture-body">
          <section class="capture-sheet" aria-label="Pairchive에 꽂기">
            <span class="sheet-handle" aria-hidden="true" style="align-self:center; width:38px; height:5px; border-radius:99px; background: rgba(27,22,18,0.18);"></span>
            ...
            <button type="button" class="ed-btn ed-btn--block">우리 책에 꽂기</button>
          </section>
        </div>
      </section>
    `;
