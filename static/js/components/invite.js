...
export function renderInvite() {
  ...
  section.className = 'screen screen--invite';
  ...
  section.innerHTML = /* html */ `
    ...
    <footer class="ed-footer">
      <button class="ed-btn ed-btn--block" type="button" data-go="invite-letter">앱 받고 함께 시작하기</button>
      <button class="ed-btn ed-btn--ghost ed-btn--block" type="button" data-go="onboarding">웹에서 미리 둘러보기</button>
