...
/**
 * 04b · 공유 시트 — 호스트 앱(Instagram) 위에서 Pairchive로 꽂기
 */
export function renderShareSheet() {
  const section = document.createElement('section');
  section.className = 'screen screen--share-sheet';
  ...
  section.innerHTML = /* html */ `
    ...
    <section class="sheet-card" aria-label="Pairchive에 꽂기">
      ...
      <button type="button" class="ed-btn ed-btn--green ed-btn--block" data-go="reading">
        우리 서재에 꽂기
      </button>
    </section>
  `;
