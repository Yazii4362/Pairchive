...
/**
 * 10 · 잠금 화면 알림 (deep link) — app.js에서 `deeplink` 이름으로도 노출
 */
export function renderLockNoti() {
  const section = document.createElement('section');
  section.className = 'screen screen--lock-noti';
  ...
  section.innerHTML = /* html */ `
    ...
    <section class="lock-notif-stack" aria-label="알림">
      <article class="lock-notif" role="article" data-go="reading">
      ...
      <article class="lock-notif" role="article" data-go="reactions">
        <div class="lock-notif__icon" aria-hidden="true">P</div>
        <div class="lock-notif__body">
          <div class="lock-notif__head">
            <span class="lock-notif__app">Pairchive</span>
...
// app.js에서 `renderDeeplink`로도 import 가능하도록 alias 노출
export { renderLockNoti as renderDeeplink };
